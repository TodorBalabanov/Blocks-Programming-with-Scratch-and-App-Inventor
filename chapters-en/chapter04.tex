...
When the player clicks on the background a flower will start to be drawn. This means that instructions should be placed on the background when it is clicked to send a "draw" message.
